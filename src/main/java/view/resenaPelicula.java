 ...
 * @author Alumno
 */
public class resenaPelicula extends javax.swing.JFrame {
    ...
    String peliculaSeleccionada = jComboBox1.getSelectedItem().toString();
    ...
    util.guardarReseña(peliculaSeleccionada, valoracion, comentario, fechaActual);
...
public void cargarPeliculas() {
    ...
    List<Peliculas> peliculas = util.obtenerPeliculasDesdeBD(id.idUsuarioActual);
    ...
    for (Peliculas pelicula : peliculas) {
        jComboBox1.addItem(pelicula.getTituloPelicula());
    }
}
    /**
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(resenaPelicula.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new resenaPelicula().setVisible(true);
            }
        });
    }
