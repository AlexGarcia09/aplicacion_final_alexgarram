 ...
 * @author Alumno
 */
public class resenaSerie extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Selecciona la serie:");
    ...
    String serieSeleccionada = jComboBox1.getSelectedItem().toString();
    int valoracion = jSlider1.getValue();
    String comentario = jTextArea1.getText();
    Date fechaActual = new Date(System.currentTimeMillis());
    
    listarSeriesUtil util = new listarSeriesUtil();
    util.guardarReseña(serieSeleccionada, valoracion, comentario, fechaActual);
...
public void cargarSeries() {
    ...
    List<Series> series = util.obtenerSeriesDesdeBD(id.idUsuarioActual);
    ...
    for (Series serie : series) {
        jComboBox1.addItem(serie.getTituloSerie());
    }
}
    /**
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(resenaSerie.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new resenaSerie().setVisible(true);
            }
        });
    }
